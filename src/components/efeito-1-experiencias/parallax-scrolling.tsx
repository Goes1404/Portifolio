...
export function ParallaxComponent() {
  ...
  useEffect(() => {
    ...
    // Smooth scrolling is handled by a single global Lenis instance in App.jsx,
    // which already syncs with ScrollTrigger — no per-effect Lenis here.
    return () => {
      if (triggerElement) {
        ...
        <div className="parallax__visuals">
          ...
          <div data-parallax-layers className="parallax__layers">
            ...
            <div data-parallax-layer="3" className="parallax__layer-title">
              <h2 className="parallax__title">CRAFT</h2>
            </div>
