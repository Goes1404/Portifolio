...
const CHAPTERS = [
  ...
  },
  {
    ...
    year: '2024',
    keyword: 'FULL STACK',
    kicker: '// web, infra, hardware — tudo junto',
    body: 'Hoje lidero o desenvolvimento da Compromisso — plataforma educacional para centenas de alunos simultâneos. Concilio freelancing, FIAP (Engenharia de Software) e projetos IoT para automação residencial. Da interface ao hardware.',
    code: `ship({\n  plataforma: 'Compromisso',\n  escala: '100+ alunos',\n  iot: true,\n  fiap: true,\n});`,
    tags: ['Full Stack', 'IoT', 'Next.js', 'TypeScript'],
    accent: '#e9edf7',
  },
] as const;
